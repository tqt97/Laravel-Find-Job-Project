...
<body class="mb-48">
    <nav class="flex justify-between items-center mb-5 shadow-md">
        <a href="/">
    ...
    <footer
        ...
        <a href="{{ route('listings.create') }}" class="absolute right-10 bg-black text-white py-2 px-5">Post Job</a>
    </footer>
